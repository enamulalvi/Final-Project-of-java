...
public class GGamingConsole extends JFrame implements ActionListener
{
	JLabel l1,l2,l3,l4,l5,l6,l7,l8,l9;
	JButton b1,b4,b5,b6,b7,b11;
	JPanel p1;

	
	public GGamingConsole()
	{
		super(" GamingConsole ");
		...
		l2 = new JLabel("COLLECTION -> GAMING CONSOLES");
		l2.setBounds(18,60,500,25);
		l2.setFont(new Font("Segoe UI",Font.BOLD,20));
		p1.add(l2);
		
		l3 = new JLabel("Nintendo Switch");
		...
		l5 = new JLabel("Sony DualSense controller");
		l5.setBounds(490,295,500,18);
		l5.setFont(new Font("Segoe UI",Font.PLAIN,15));
		p1.add(l5);
		
		l7 = new JLabel("BDT 0000tk");
		l7.setBounds(510,320,200,15);
		l7.setFont(new Font("Segoe UI",Font.PLAIN,15));
		p1.add(l7);
		
		l6 = new JLabel("sony playstation 4");
		l6.setBounds(170,530,500,18);
