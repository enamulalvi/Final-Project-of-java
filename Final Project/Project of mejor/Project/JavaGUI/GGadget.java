...
public class GGadget extends JFrame implements ActionListener
{
	...
	public GGadget()
	{
		...
		l5 = new JLabel("Apple Airpods Pro");
		l5.setBounds(490,290,500,19);
		...
		l6 = new JLabel("BASEUS Power Bank");
		...
		l7 = new JLabel("TP Link WIFI Router");
