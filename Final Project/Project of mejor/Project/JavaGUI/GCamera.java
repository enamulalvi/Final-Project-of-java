...
public class GCamera extends JFrame implements ActionListener
{
	...
	public GCamera()
	{
		...
		l5 = new JLabel("GoPro Hero 11");
		l5.setBounds(480,300,500,15);
		...
		l6 = new JLabel("Nikon DSLR");
		l6.setBounds(150,535,500,19);
		...
		l7 = new JLabel("Sony Alpha A6300");
		l7.setBounds(480,535,500,19);
