...
public class GSmartPhone extends JFrame implements ActionListener
{
	...
	public GSmartPhone()
	{
		...
		l2 = new JLabel("COLLECTION -> SMART PHONES");
		l2.setBounds(18,65,500,25);
		l2.setFont(new Font("Segoe UI",Font.BOLD,20));
		p1.add(l2);
		
		l3 = new JLabel("iPhone 15 Pro Max");
		...
		l5 = new JLabel("Samsung Galaxy S23 Ultra");
		l5.setBounds(520,295,180,19);
